...
const unsigned char zone_names[826] = {
                            ...
                            'B','u','e','n','o','s',' ','A','i','r','e','s','\0',   5, // Buenos Aires
                                ...
                                'H','o',' ','C','h','i',' ','M','i','n','h','\0',  18, // Ho Chi Minh
                                        ...
                                        'K','a','t','h','m','a','n','d','u','\0',  23, // Kathmandu
                                ...
                                'M','e','x','i','c','o',' ','C','i','t','y','\0',  11, // Mexico City
                                            ...
                                            'N','e','w',' ','Y','o','r','k','\0',  12, // New York
                                                ...
                                                'P','h','o','e','n','i','x','\0',  14, // Phoenix
                                                            'P','u','n','e','\0',  24, // Pune
                                            'Q','u','a','n','z','h','o','u','\0',  27, // Quanzhou
                                                    'R','e','g','i','n','a','\0',  15, // Regina
                    'R','i','o',' ','d','e',' ','J','a','n','e','i','r','o','\0',   5, // Rio de Janeiro
                        'S','a','n',' ','F','r','a','n','c','i','s','c','o','\0',   9, // San Francisco
                                            'S','a','n','t','i','a','g','o','\0',  16, // Santiago
